...
import { OpenAiModelResponse } from "#/lib/types/open-ai";
...
export const makeServerPostRequest = async <TResponse, TRequestBody>(
  ...
  return makeAsyncServerRequest<TResponse, TRequestBody>(
    endpoint,
    "POST",
    body,
  );
...
export const fetchModels = () => {
  return makeAsyncServerRequest<OpenAiModelResponse, {}>(
    MODELS_ENDPOINT,
    "GET",
  );
};
